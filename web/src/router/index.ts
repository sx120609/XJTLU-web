  ...
  routes: [
    ...
    { path: "/register", name: "register", component: () => import("@/views/Register.vue"), meta: { public: true, title: "注册" } },
    {
      ...
      children: [
        ...
        { path: "market/learning-materials/publish", name: "market-learning-materials-publish", component: () => import("@/views/market/Publish.vue"), meta: { title: "发布学习资料", marketCatalog: "learning-materials" } },
        { path: "market/learning-materials/item/:id/edit", name: "market-learning-materials-edit", component: () => import("@/views/market/Publish.vue"), meta: { title: "编辑学习资料", marketCatalog: "learning-materials" } },
