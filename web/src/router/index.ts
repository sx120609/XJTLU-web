  ...
  routes: [
    ...
    { path: "/register", name: "register", component: () => import("@/views/Register.vue"), meta: { public: true, title: "注册" } },
    {
      ...
      children: [
        ...
        { path: "market/merchant/apply", name: "market-merchant-apply", component: () => import("@/views/market/MerchantApply.vue"), meta: { title: "商户资料" } },
        ...
        { path: "learning/free", name: "market-learning-materials", component: () => import("@/views/market/LearningMaterials.vue"), meta: { title: "靠浦特色学习资料", public: true } },
        { path: "learning/free/publish", name: "market-learning-materials-publish", component: () => import("@/views/market/LearningMaterialPublish.vue"), meta: { title: "发布免费原创" } },
        { path: "learning/free/item/:id/edit", name: "market-learning-materials-edit", component: () => import("@/views/market/LearningMaterialPublish.vue"), meta: { title: "编辑免费原创" } },
        { path: "learning/free/item/:id", name: "market-learning-material-item", component: () => import("@/views/market/LearningMaterialDetail.vue"), meta: { title: "原创内容详情", public: true } },
        ...
        { path: "market/learning-materials", redirect: "/learning/free" },
        { path: "market/learning-materials/publish", redirect: "/learning/free/publish" },
