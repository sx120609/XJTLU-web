  ...
  routes: [
    ...
    { path: "/register", name: "register", component: () => import("@/views/Register.vue"), meta: { public: true, title: "注册" } },
    {
      ...
      children: [
        ...
        { path: "market/merchants", redirect: "/market" },
        { path: "market/merchant/apply", redirect: "/market" },
        { path: "market/merchant/:slug", redirect: "/market" },
        ...
        { path: "learning/publisher", name: "market-learning-creator", component: () => import("@/views/market/LearningCreatorCenter.vue"), meta: { title: "学习资料发布中心" } },
        { path: "learning/creator", redirect: "/learning/publisher" },
