  ...
  routes: [
    ...
    { path: "/register", name: "register", component: () => import("@/views/Register.vue"), meta: { public: true, title: "注册" } },
    {
      ...
      children: [
        ...
        { path: "market/learning-materials", name: "market-learning-materials", component: () => import("@/views/market/LearningMaterials.vue"), meta: { title: "靠浦特色学习资料", public: true, marketCatalog: "learning-materials" } },
        { path: "market/learning-materials/publish", name: "market-learning-materials-publish", component: () => import("@/views/market/LearningMaterialPublish.vue"), meta: { title: "发布学习资料", marketCatalog: "learning-materials" } },
        { path: "market/learning-materials/item/:id/edit", name: "market-learning-materials-edit", component: () => import("@/views/market/LearningMaterialPublish.vue"), meta: { title: "编辑学习资料", marketCatalog: "learning-materials" } },
        { path: "market/learning-materials/item/:id", name: "market-learning-material-item", component: () => import("@/views/market/LearningMaterialDetail.vue"), meta: { title: "学习资料详情", public: true, marketCatalog: "learning-materials" } },
        { path: "market/learning-materials/library", name: "market-learning-material-library", component: () => import("@/views/market/LearningMaterialLibrary.vue"), meta: { title: "我的资料库", marketCatalog: "learning-materials" } },
        { path: "market/learning-materials/support", name: "market-learning-material-support", component: () => import("@/views/market/LearningMaterialSupport.vue"), meta: { title: "学习资料售后", marketCatalog: "learning-materials" } },
