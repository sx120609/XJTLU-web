...
.endpoint-card { display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 16px 18px; border: 1px solid var(--cpu-border-soft); border-radius: 14px; background: linear-gradient(135deg, var(--cpu-surface-soft), var(--cpu-card)); }
...
.setting-card { padding: 18px; border: 1px solid var(--cpu-border-soft); border-radius: 14px; background: var(--cpu-card); }
...
.agent-card { overflow: hidden; border: 1px solid var(--cpu-border-soft); border-radius: 16px; background: var(--cpu-card); box-shadow: var(--cpu-shadow-sm); transition: opacity .2s, border-color .2s; }
...
.capability-item { display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 13px 14px; border: 1px solid var(--cpu-border-soft); border-radius: 12px; background: var(--cpu-card); }
...
.login-health.healthy { background: color-mix(in srgb, var(--cpu-success) 14%, var(--cpu-card)); color: var(--cpu-success); }
.login-health.unavailable { background: color-mix(in srgb, var(--cpu-danger) 14%, var(--cpu-card)); color: var(--cpu-danger); }
.login-health span { overflow-wrap: anywhere; opacity: .85; }
.agent-login-error { display: flex; align-items: flex-start; gap: 10px; margin: 0 20px 2px; padding: 10px 12px; border: 1px solid color-mix(in srgb, var(--cpu-danger) 34%, transparent); border-radius: 10px; background: color-mix(in srgb, var(--cpu-danger) 12%, var(--cpu-card)); color: var(--cpu-danger); font-size: 12px; line-height: 1.5; }
...
.token-state { color: var(--cpu-text-secondary); font-size: 12px; }
