  ...
  <div class="materials-page">
    ...
    <section class="materials-hero">
      <div class="hero-copy">
        ...
        <h1>靠浦特色学习资料</h1>
        <p>按课程代码、学习阶段和资料类型精准找到真正适合自己的校园学习内容。</p>
        <div><em>课程维度检索</em><em>平台托管交付</em><em>订单售后留痕</em></div>
      </div>
      <div class="hero-side">
    ...
    <section class="results-head">
      ...
      <el-select v-model="filters.sort" class="sort-select" @change="search"><el-option label="最新发布" value="new" /><el-option label="人气优先" value="popular" /><el-option label="价格从低到高" value="price_asc" /><el-option label="价格从高到低" value="price_desc" /></el-select>
    </section>
...
const filters=reactive({q:String(route.query.q||""),courseCode:String(route.query.courseCode||""),semester:String(route.query.semester||""),typeId:route.query.typeId?Number(route.query.typeId):undefined as number|undefined,format:String(route.query.format||""),sort:(String(route.query.sort||"new") as "new"|"popular"|"price_asc"|"price_desc")});
