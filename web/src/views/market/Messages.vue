      ...
      <aside :class="{ hidden: selectedId && mobileConversation }">
        ...
        >
          ...
          <span>
            ...
            <small v-if="conversation.counterpart?.major" class="counterpart-major">{{ conversation.counterpart.major }}</small>
      ...
      <main v-if="activeConversation" class="messages">
        <div class="message-head">
          ...
          <div>
            ...
            <small v-if="activeConversation.counterpart?.major" class="counterpart-major">{{ activeConversation.counterpart.major }}</small>
          </div>
...
.counterpart-major{color:var(--cpu-text-secondary)!important;font-size:10px}
</style>
