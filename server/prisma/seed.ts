...
async function main() {
  ...
  const services = [
    ...
    { code: "XJTLU_LIBRARY", name: "西浦图书馆", category: "学习", owner: "西交利物浦大学图书馆", icon: "📚",
      url: "https://lib.xjtlu.edu.cn/", needSso: false,
      description: "检索馆藏、电子资源、数据库、学习空间与研究支持",
      materials: "部分资源需学校统一身份认证", duration: "即时", contact: "Library-Service@xjtlu.edu.cn" },
    { code: "XJTLU_LM_CORE", name: "Learning Mall Core", category: "学习", owner: "西交利物浦大学学习超市", icon: "🎓",
      url: "https://core.xjtlu.edu.cn/", needSso: true,
      description: "校内在线教学平台，访问课程模块、学习活动与教学资源",
      materials: "学校统一身份认证账号", duration: "即时", contact: "learningmall@xjtlu.edu.cn" },
    { code: "XJTLU_KNOWLEDGE_BASE", name: "XJTLU Knowledge Base", category: "学习", owner: "西交利物浦大学", icon: "🧭",
      url: "https://knowledgebase.xjtlu.edu.cn/", needSso: false,
      description: "查询学校系统与学习平台的官方使用指南和帮助文档",
      materials: "无需材料", duration: "即时" },
