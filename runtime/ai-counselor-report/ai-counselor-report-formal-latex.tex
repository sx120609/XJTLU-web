...
\hypersetup{
  ...
  urlcolor=TitleBlue,
  citecolor=TitleBlue,
  pdftitle={关于我们AI辅导员产品形态与能力边界的建议},
  pdfauthor={沈礼},
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small 关于我们AI辅导员产品形态与能力边界的建议}
...
\begin{titlepage}
  ...
  {\centering
  {\fontsize{19pt}{27pt}\selectfont\bfseries\color{TitleBlue}\parbox{0.96\linewidth}{\centering 关于我们AI辅导员产品形态与能力边界的建议}\par}
  \vspace{0.8cm}
  {\Large 围绕产品结构、能力组织与论坛边界的阶段性整理\par}
  \vspace{0.8cm}
  {\normalsize\color{TextGray} 作者：24药化5班\quad 沈礼\quad | \quad 药大拾间开发者\par}
  \vspace{1.6cm}
  }
  ...
  \summarybox{\color{black}\textbf{摘要说明：}本报告围绕 AI 辅导员的定位、首页结构、能力组织以及论坛能力的吸收边界展开，目标不是单纯优化视觉，而是帮助我们把产品从“聊天页思路”转向“学生服务工作台思路”，形成一套更适合校内正式场景、也更利于持续建设的产品框架。}
...
总的来说，这个产品真正值得追求的，不是“像一个更聪明的聊天框”，而是“像一个更懂校园场景、更能帮助学生把事情办下去的系统”。换句话说，我们真正要建设的，不是一个更会说话的页面，而是一个更会承接校园事务的系统入口。
